...
top_plot <- annotate_figure(top_plot, top=text_grob("E. coli BW25113", face = "italic", size = 10))
middle_plot <- annotate_figure(middle_plot, top=text_grob("E. coli K-12 MG1655", face = "italic", size = 10))
bottom_plot <- annotate_figure(bottom_plot, top=text_grob("S. Typhimurium 14028S", face = "italic", size = 10))
