...
### Simulation data: 100,000 IS, lambda=0.8 & 25 hot 
simulated_data <- readRDS("./simulatedData/SimuData_Tnseq_GeneClusters_ess_ORF_uniform_numLoci_100000_lambda_0.8_num_hot_spots_25_hot_spot_size_10000_num_cold_spots_0_cold_spot_size_10000_NBnc_100_NBdis_1_NBp_0.3_tecnoise_0.RDS")
...
saveRDS(out_perm_binomial, "./results/subsamples_binomial_example_simu4.RDS")
...
saveRDS(out_perm_connis, "./results/subsamples_connis_example_simu4.RDS")
...
saveRDS(out_perm_expvsgamma, "./results/subsamples_expvsgamma_example_simu4.RDS")
...
saveRDS(out_perm_geometric, "./results/subsamples_geometric_example_simu4.RDS")
...
saveRDS(out_perm_insdens, "./results/subsamples_insdens_example_simu4.RDS")
...
saveRDS(out_perm_tn5gaps, "./results/subsamples_tn5gaps_example_simu4.RDS")
...
saveRDS(stabilities, "./performance/stabilities_example_simu4.RDS")
