...
### Simulation data: 100,000 IS, 0% noise, lambda=0.75, sine 
simulated_data <- readRDS("./simulatedData/SimuData_Tnseq_GeneClusters_ess_ORF_uniform_numLoci_100000_lambda_0.75_bp_per_wave_2e+06_sine_scaling_factor_1.3_NBnc_100_NBdis_1_NBp_0.3_tecnoise_0.RDS")
...
saveRDS(out_perm_binomial, "./results/subsamples_binomial_example_simu2.RDS")
...
saveRDS(out_perm_connis, "./results/subsamples_connis_example_simu2.RDS")
...
saveRDS(out_perm_expvsgamma, "./results/subsamples_expvsgamma_example_simu2.RDS")
...
saveRDS(out_perm_geometric, "./results/subsamples_geometric_example_simu2.RDS")
...
saveRDS(out_perm_insdens, "./results/subsamples_insdens_example_simu2.RDS")
...
saveRDS(out_perm_tn5gaps, "./results/subsamples_tn5gaps_example_simu2.RDS")
...
saveRDS(stabilities, "./performance/stabilities_example_simu2.RDS")
