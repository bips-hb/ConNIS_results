...
# Oroginal source: https://genomics.lbl.gov/supplemental/rbarseq/html/Keio/all.poolcount
    ...
    unique(
      (all_IS_raw %>% 
         filter(Keio_ML9_set1.IT001 >0 | 
                  ...
                  Keio_ML9_set1.IT049  > 0 | 
                  Keio_ML9_set1.IT050 >0) 
      )$pos
    )
  )
  )
...
saveRDS(out_perm_binomial, "./results/subsamples_binomial_bw25113.RDS")
...
saveRDS(out_perm_connis, "./results/subsamples_connis_bw25113.RDS")
...
saveRDS(out_perm_expvsgamma, "./results/subsamples_expvsgamma_bw25113.RDS")
...
saveRDS(out_perm_geometric, "./results/subsamples_geometric_bw25113.RDS")
...
saveRDS(out_perm_insdens, "./results/subsamples_insdens_bw25113.RDS")
...
saveRDS(out_perm_tn5gaps, "./results/subsamples_tn5gaps_bw25113.RDS")
...
saveRDS(stabilities, "./performance/stabilities_bw25113.RDS")
