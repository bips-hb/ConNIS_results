# script for aplying the Method Tn5Gap of Transit 
...
results_tn5gap <- parLapply(cl, seq_along(simulated_data), function(sim_run){
...
if(distortion == "sin"){
  saveRDS(results_tn5gap, 
          file= paste("./results/Results_tn5gap",
                      "_ess_ORF_", ess_ORF,
                      "_numLoci_", format(unique_loci, scientific = F),
                      "_lambda_",lambda,
                      "_bp_per_wave_", bp_per_wave , 
