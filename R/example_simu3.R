...
### Simulation data: 200,000 IS, 2% noise, lambda=0.8, 25 hot & 0 cold spots 
simulated_data <- readRDS("./simulatedData/SimuData_Tnseq_GeneClusters_ess_ORF_uniform_numLoci_200000_lambda_0.8_num_hot_spots_25_hot_spot_size_10000_num_cold_spots_0_cold_spot_size_10000_NBnc_100_NBdis_1_NBp_0.3_tecnoise_0.02.RDS")
...
saveRDS(performances, file="./performance/Performance_example_simu3.RDS")
