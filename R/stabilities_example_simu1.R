...
saveRDS(out_perm_binomial, "./results/subsamples_binomial_example_simu1.RDS")
...
saveRDS(out_perm_connis, "./results/subsamples_connis_example_simu1.RDS")
...
saveRDS(out_perm_expvsgamma, "./results/subsamples_expvsgamma_example_simu1.RDS")
...
saveRDS(out_perm_geometric, "./results/subsamples_geometric_example_simu1.RDS")
...
saveRDS(out_perm_insdens, "./results/subsamples_insdens_example_simu1.RDS")
...
saveRDS(out_perm_tn5gaps, "./results/subsamples_tn5gaps_example_simu1.RDS")
...
saveRDS(stabilities, "./performance/stabilities_example_simu1.RDS")
