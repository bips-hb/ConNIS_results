# script for applying Geometric Distribution 
source("./functions.R")
...
results_geometric <- parLapply(cl, seq_along(simulated_data), function(sim_run){
...
if(distortion == "sin"){
  saveRDS(results_geometric, 
          file= paste("./results/Results_geometric",
                      "_ess_ORF_", ess_ORF,
                      "_numLoci_", format(unique_loci, scientific = F),
                      "_lambda_",lambda,
                      "_bp_per_wave_", bp_per_wave , 
